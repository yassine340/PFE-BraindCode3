<template>
  <footer class="bg-[#0072B5] text-white py-10 px-6 md:px-16">
    <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
      
      <!-- Logo and Description -->
      <div>
        <h2 class="font-bold text-lg mb-2">BraindCode Startup Studio</h2>
      ...
      <!-- Contact -->
      <div>
        <h3 class="font-bold mb-3">Contactez-nous</h3>
        <ul class="space-y-2">
...
<style scoped>
/* Add hover effect or color overrides if needed */
</style>