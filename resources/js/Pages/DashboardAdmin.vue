            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 transition-transform hover:scale-105">
                        ...
                        <div class="flex items-end justify-between">
                            <div>
                                <span class="text-3xl font-bold text-gray-900">{{ formatCurrency(stats.revenus) }}</span>
                                <p class="text-green-500 text-sm flex items-center mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />
                                    </svg>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-2 gap-4">
                            ...
                            <Link href="/admin/users" class="flex flex-col items-center justify-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                            ...
                            <Link href="/categorie" class="flex flex-col items-center justify-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                            ...
                            <Link href="/PaymentTransactionsAdmin" class="flex flex-col items-center justify-center p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors">
